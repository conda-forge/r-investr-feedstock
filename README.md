...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-investr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8326&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-investr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-investr` can be installed with:

```
conda install r-investr
```

It is possible to list all of the versions of `r-investr` available on your platform with:
